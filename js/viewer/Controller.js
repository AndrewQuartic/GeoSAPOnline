define([
...
], function (Map, dom, domStyle, domGeom, domClass, on, array, BorderContainer, ContentPane, FloatingTitlePane, lang, mapOverlay, FloatingWidgetDialog, put, aspect, has, topic, Stateful, PopupMobile, Menu, webMercatorUtils) {
	...
	return {
		...
		addTopics: function () {
			...
			// [atangeman20150115]
			// set a channel to receive callback. Results will drop here
            topic.subscribe('externalRequest/identifyCallback', lang.hitch(this, function (e) {  
            	topic.publish('controller/identifyResult', {
            		returnObj: e.returnObj
            	});
            }));
		},
		// set titles (if any)
		...
		// [atangeman20150115]
		// Handle identify request passed from root index.html 
		// Parse object variables and publish to Identify.js listener
		handleIdentifyRequest: function (options) {
			this.options = options; // sender object
			var me = this;
